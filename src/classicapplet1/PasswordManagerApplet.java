...
public class PasswordManagerApplet extends Applet implements ISO7816, AppletEvent, ExtendedLength {
  ...
  public static void install(byte[] bArray, short bOffset, byte bLength) {
    new PasswordManagerApplet().register();
  }

  /**
   * Only this class's install method should create the applet object.
   */
  protected PasswordManagerApplet() {
